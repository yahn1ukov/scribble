module github.com/yahn1ukov/scribble/apps/note

go 1.22.4

replace (
	github.com/yahn1ukov/scribble/apps/notebook => ../notebook
...
require (
	...
	github.com/yahn1ukov/scribble/apps/notebook v0.0.0-00010101000000-000000000000
